...
function calculateQuantities(listIngredients,cakeLayers){
// 100grams - sugar per layer, eggs =2 eggs per layer 
let obj={}
listIngredients.includes('sugar') ? obj.sugar = cakeLayers*100 : obj.sugar=0
listIngredients.includes('eggs') ? obj.eggs = cakeLayers*2 : obj.eggs=0
return obj
}
